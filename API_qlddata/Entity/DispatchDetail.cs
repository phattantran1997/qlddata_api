...
namespace API_premierductsqld.Entities
{
    public class DispatchDetail
    {
        ...
        public DispatchDetail(FactoryFit factoryFit)
        {
            this.jobno = factoryFit.jobno;
            this.insulationarea = factoryFit.insulationarea;
            this.metalarea = factoryFit.metalarea;
            this.cuttype = factoryFit.cuttype;
            this.insulationSpec = factoryFit.insulationSpec;
        }
    }
}
